...
var block = {
  ...
  change: function(force, event){
    ...
    var num = (-90)+(force*170);
    console.log('num', num);
    $('#type').css({
        fontVariationSettings: "'wght'"+ num +", 'ital' 0"
      });
  },
  ...
  startDeepPress: function(event){
    ...
    $('h3').css({
        fontVariationSettings: "'wght'"+ (-90) +", 'ital' 0"
      });
  },
...
// Pressure.set(document.querySelectorAll('#type'), block);
Pressure.set($('#type'), block, {only: 'mouse', polyfill: true, polyfillSpeedUp: 500, polyfillSpeedDown: 1000});
